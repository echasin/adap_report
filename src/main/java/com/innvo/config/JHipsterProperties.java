...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "adap_report@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "adap_report API";

        private String description = "adap_report API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "adap_report";
